...
def PrepareNetgen2dModelGeometry(domain_radius, tool_geometry, formation_geometry, borehole_geometry):
...
def ConstructNetgen2dModel(domain_radius, tool_geometry_list, source_terms_list, formation_geometry_list, borehole_geometry_list, points_y_offsets):
    ...
    for model_index in range(len(tool_geometry_list)):
        ...
        ### 
        points, lines = PrepareNetgen2dModelGeometry(domain_radius, tool_geometry, formation_geometry, borehole_geometry)
