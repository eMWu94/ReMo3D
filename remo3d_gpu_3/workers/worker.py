...
for msg in iter(lambda: comm.sendrecv(None, dest=0), None):
    ...
    if len(tasks)==computation_batch_size or msg==StopIteration:
        ...
        meshing_offsets = np.arange(0, 2.01*domain_radius*len(tasks), 2.01*domain_radius)
        ...
        # Generate mesh using netgen
            ...
            # Create geometry and mesh
            mesh = ngf.ConstructNetgen2dModel(domain_radius, tool_geometry_list, source_terms_list, local_formation_geometry_list, local_borehole_geometry_list, meshing_offsets)
        ...
        for i, task in enumerate(tasks):
            ...
            for modelling_task in task[2]:
                ...
                for rc_task in modelling_task[2]:
                    ...
                    offset = rc_task[2]
                    tool_geometry = tools_parameters[tool][0,:3] + offset + meshing_offset
