...
def ConstructNetgen2dModel(domain_radius, tool_geometry, formation_geometry, borehole_geometry, source_terms, output_folder_path="./meshfiles", output_mode="variable"):
