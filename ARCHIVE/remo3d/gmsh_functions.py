...
def SelectGmshDataRange(borehole_geometry, formation_parameters, dip, mud_resistivity, simulation_depth, domain_radius, active_geometry_window=0.99):
    ...
    local_borehole_geometry = SelectGmshBoreholeDataRange(borehole_geometry, dip, simulation_depth, domain_radius, active_geometry_window)
    ...
    sigma = [1/mud_resistivities[depth_index]] + list(1/local_formation_resistivity)
...
def ConstructGmsh2dModel(domain_radius, tool_geometry, source_terms, formation_geometry, borehole_geometry, file_number, mesh_generator, output_folder_path="./meshfiles", output_mode="variable"):
